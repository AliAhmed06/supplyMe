  ...
  return (
    <div className='mb-20'>
      ...
      <div className='text-center py-10'>
        ...
        <p className='text-gray2 text-sm'>Home <span className='tracking-[-2px]'>&gt;&gt;</span> About Us </p>
      </div>
      ...
      <Container1 headingTitle={"About R&R General Supply"}>
        <div className="w-full ">
          ...
          <p className="md:w-[70%] mx-auto text-center text-lg px-5 py-10 text-gray2 font-semibold leading-normal">Welcome to R&R General Supply. We have proudly served Astoria, Queens and the rest of the five boroughs since
              ...
              Most importantly, regardless of their size, our customers all receive the same outstanding level of personal service.
              If you judge a company by the company it keeps, we are definitely in good company</p>
        </div>
      </Container1>
