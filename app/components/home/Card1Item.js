...
const Card1Item = ({img, title1, title2, link}) => {
  return (
    <div className={` ${title2 === "Drill Drivers" ? "bg-[url('/images/home/section-bg1.png')]" : "bg-[url('/images/home/section-bg2.png')]"}   h-full w-full  rounded-md text-white flex flex-col px-16 py-5 items-start justify-center bg-cover`}>
