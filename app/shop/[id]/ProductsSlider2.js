          ...
          >        
              { data.map((item) => (
                <SwiperSlide key={item.title}>                  
                  <div className="h-full w-full bg-[#f2f2f2] cursor-pointer" onClick={() => setSliderImg(item.img)}>
                    <img src={item.img} alt="" className="h-full w-full object-contain bg-white border border-gray1 " />
                  </div>                                                                   
                </SwiperSlide>                        
              ))} 
          </Swiper>          
