  ...
  return (
    <div className='mb-20'>
      ...
      <div className='text-center py-10'>
        ...
        <p className='text-gray2 text-sm'>Home <span className='tracking-[-2px]'>&gt;&gt;</span>  Shop <span className='tracking-[-2px]'>&gt;&gt;</span>  Impact Wrench </p>
      </div>
          ...
          <div className='w-[60%] lg:w-[75%]'>           
            ...
            <div className='flex flex-col lg:flex-row gap-10'>
                <div className='w-full lg:w-[30%]'>
                    <img src={sliderImg} alt="" className='w-full object-contain md:h-[400px] border border-gray1 mb-10' />
                    <ProductSlider2 
                        data={[
                            {'title':'Tulip Block1', 'img':'/images/products/product1.jpg', 'quantity':'120','link':'#'},            
                            {'title':'Tulip Block2', 'img':'/images/products/product2.jpg', 'quantity':'120','link':'#'},            
                            {'title':'Tulip Block3', 'img':'/images/products/product3.jpg', 'quantity':'120','link':'#'},            
                            {'title':'Tulip Block4', 'img':'/images/products/product4.jpg', 'quantity':'120','link':'#'},            
                            {'title':'Tulip Block5', 'img':'/images/products/product5.jpg', 'quantity':'120','link':'#'},            
                          ]}
            ...
            <div className='my-10 lg:my-20'>
              <h3 className='text-xl font-bold text-black border-b border-gray1 pb-3'>RELATED PRODUCTS</h3>
